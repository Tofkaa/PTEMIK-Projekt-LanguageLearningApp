/**
 * @file StudentAssignmentList.jsx
 * @description Component for students to view their pending and active assignments across all enrolled classrooms.
 */
...
/**
 * @component
 * @returns {React.ReactElement} Grid view of active assignments.
 */
const StudentAssignmentList = () => {
    ...
    /**
     * Fetches all currently available assignments across all joined classrooms.
     * 
     * @async
                                ...
                                <Card.Body className="d-flex flex-column">
                                    ...
                                    <ListGroup variant="flush" className="bg-transparent border-top border-secondary pt-2 flex-grow-1">
                                        ...
                                        <ListGroup.Item className="bg-transparent text-light border-0 p-1 d-flex align-items-center" style={{ fontSize: '0.9rem' }}>
                                            ...
                                            <span className="fw-bold text-warning">{formatToLocalDisplay(a.availableUntil)}</span>
                                        </ListGroup.Item>
                                        <ListGroup.Item className="bg-transparent text-light border-0 p-1 d-flex align-items-center" style={{ fontSize: '0.9rem' }}>
