                                        ...
                                        pendingMembers.map(member => (
                                            <ListGroup.Item key={member.memberId} className="bg-dark text-light border-secondary d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <div className="text-secondary" style={{ fontSize: '0.8rem' }}>{member.email}</div>
                                                </div>
                                ...
                                <ListGroup variant="flush">
                                    {acceptedMembers.length === 0 ? (
                                        ...
                                        acceptedMembers.map(member => (
                                            <ListGroup.Item key={member.memberId} className="bg-dark text-light border-secondary d-flex justify-content-between align-items-center">
                                                <div>
                                                    <div className="fw-bold">{member.name} <span className="text-muted">#{member.userTag}</span></div>
                            ...
                            <Col md={6}>
                                <div className="p-3 border border-secondary rounded bg-darker h-100">
                                    ...
                                    {selectedLessonId && availableExercises.length === 0 && (
                                        <p className="text-muted mt-3">Ebben a leckében nincsenek feladatok.</p>
                                    )}
                                </div>
                            </Col>
                        </Row>
